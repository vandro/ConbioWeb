...
<div class="login-box">
    <div class="login-logo">
        <?= Html::a('<img style="width: 77px; height: 99px;" alt="logo" src="theme/fullpage/assets/images/logo.png"><b>ConbioWeb</b>', ['/'], ['class' => ""]) ?>
...
<br/><br/>-->
            <?= Html::a(Yii::t("user", "Register"), ["/user/register"]) ?> <br>
